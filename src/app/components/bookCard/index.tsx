  ...
  return (
    <CardContainer>
      <ItemContainer>
        ...
        <Name onClick={toogleStartCalendar}>Pick Up Date</Name>
        <SmallIcon>
      ...
      <ItemContainer>
        ...
        <Name onClick={toogleReturnCalendar}>Return Date</Name>
        <SmallIcon>
